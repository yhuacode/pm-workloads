...
# Based on a script from "Angora: Efficient Fuzzing by Principled Search", S&P 2018
# https://github.com/AngoraFuzzer/Angora/blob/master/tools/gen_library_abilist.sh
